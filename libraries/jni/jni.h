...
/*
 * used in RegisterNatives to describe native method modName, signature,
...
struct JNINativeInterface_ {
    ...
    jobjectArray (JNICALL *NewObjectArray)
      (JNIEnv *env, jsize len, jclass clazz, jobject inject);
...
struct JNIEnv_ {
    ...
    void DeleteLocalRef(jobject obj) {
        if (obj) functions->DeleteLocalRef(this, obj);
    }
    ...
    jobjectArray NewObjectArray(jsize len, jclass clazz,
                                jobject inject) {
        return functions->NewObjectArray(this,len,clazz,inject);
    }
